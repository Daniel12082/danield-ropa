...
{
    [DbContext(typeof(danieldropaContext))]
    partial class danieldropaContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("Core.Entities.Empleado", b =>
                {
                    ...
                    b.HasOne("Core.Entities.Municipio", null)
                        .WithMany("Empleados")
            ...
            modelBuilder.Entity("Core.Entities.Proveedor", b =>
                {
                    ...
                    b.HasOne("Core.Entities.TipoPersona", null)
