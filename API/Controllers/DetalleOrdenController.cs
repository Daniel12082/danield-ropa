...
public class DetalleOrdenController: BaseControllerApi
    {
        ...
        {
            var entidades = await _unitOfWork.DetalleOrdenes.GetAllAsync();
        ...
        {
            var entidad = await _unitOfWork.DetalleOrdenes.GetByIdAsync(id);
            if(entidad == null)
            {
                return NotFound();
            }
        ...
        public async Task<ActionResult<DetalleOrden>> Post(DetalleOrdenDto DetalleOrdenDto)
        {
            ...
            this._unitOfWork.DetalleOrdenes.Add(entidad);
        ...
        public async Task<ActionResult<DetalleOrdenDto>> Put(int id, [FromBody] DetalleOrdenDto DetalleOrdenDto)
        {
            ...
            _unitOfWork.DetalleOrdenes.Update(entidades);
            await _unitOfWork.SaveAsync();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.DetalleOrdenes.Delete(entidad);
            await _unitOfWork.SaveAsync();
            return NoContent();
        }
    }
