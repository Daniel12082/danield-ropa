...
public class TipoPersonaController: BaseControllerApi
    {
        ...
        {
            var entidades = await _unitOfWork.TiposPersona.GetAllAsync();
        ...
        {
            var entidad = await _unitOfWork.TiposPersona.GetByIdAsync(id);
            if(entidad == null)
            {
                return NotFound();
            }
        ...
        public async Task<ActionResult<TipoPersona>> Post(TipoPersonaDto TipoPersonaDto)
        {
            ...
            this._unitOfWork.TiposPersona.Add(entidad);
        ...
        public async Task<ActionResult<TipoPersonaDto>> Put(int id, [FromBody] TipoPersonaDto TipoPersonaDto)
        {
            ...
            _unitOfWork.TiposPersona.Update(entidades);
            await _unitOfWork.SaveAsync();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.TiposPersona.Delete(entidad);
            await _unitOfWork.SaveAsync();
            return NoContent();
        }
    }
