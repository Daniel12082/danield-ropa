...
public class TipoProteccionController: BaseControllerApi
    {
        ...
        {
            var entidades = await _unitOfWork.TiposProteccion.GetAllAsync();
        ...
        {
            var entidad = await _unitOfWork.TiposProteccion.GetByIdAsync(id);
            if(entidad == null)
            {
                return NotFound();
            }
        ...
        public async Task<ActionResult<TipoProteccion>> Post(TipoProteccionDto TipoProteccionDto)
        {
            ...
            this._unitOfWork.TiposProteccion.Add(entidad);
        ...
        public async Task<ActionResult<TipoProteccionDto>> Put(int id, [FromBody] TipoProteccionDto TipoProteccionDto)
        {
            ...
            _unitOfWork.TiposProteccion.Update(entidades);
            await _unitOfWork.SaveAsync();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.TiposProteccion.Delete(entidad);
            await _unitOfWork.SaveAsync();
            return NoContent();
        }
    }
