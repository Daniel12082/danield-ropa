...
public class TipoEstadoController: BaseControllerApi
    {
        ...
        {
            var entidades = await _unitOfWork.TiposEstado.GetAllAsync();
        ...
        {
            var entidad = await _unitOfWork.TiposEstado.GetByIdAsync(id);
            if(entidad == null)
            {
                return NotFound();
            }
        ...
        public async Task<ActionResult<TipoEstado>> Post(TipoEstadoDto TipoEstadoDto)
        {
            ...
            this._unitOfWork.TiposEstado.Add(entidad);
        ...
        public async Task<ActionResult<TipoEstadoDto>> Put(int id, [FromBody] TipoEstadoDto TipoEstadoDto)
        {
            ...
            _unitOfWork.TiposEstado.Update(entidades);
            await _unitOfWork.SaveAsync();
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.TiposEstado.Delete(entidad);
            await _unitOfWork.SaveAsync();
            return NoContent();
        }
    }
