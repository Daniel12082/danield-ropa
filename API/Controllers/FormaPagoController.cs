...
public class FormaPagoController: BaseControllerApi
    {
        ...
        {
            var entidades = await _unitOfWork.FormasPago.GetAllAsync();
        ...
        {
            var entidad = await _unitOfWork.FormasPago.GetByIdAsync(id);
            if(entidad == null)
            {
                return NotFound();
            }
        ...
        public async Task<ActionResult<FormaPago>> Post(FormaPagoDto FormaPagoDto)
        {
            ...
            this._unitOfWork.FormasPago.Add(entidad);
        ...
        public async Task<ActionResult<FormaPagoDto>> Put(int id, [FromBody] FormaPagoDto FormaPagoDto)
        {
            ...
            _unitOfWork.FormasPago.Update(entidades);
            await _unitOfWork.SaveAsync();
            return FormaPagoDto;
        }
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.FormasPago.Delete(entidad);
            await _unitOfWork.SaveAsync();
            return NoContent();
        }
    }
