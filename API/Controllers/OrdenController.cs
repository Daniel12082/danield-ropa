...
public class OrdenController: BaseControllerApi
    {
        ...
        {
            var entidades = await _unitOfWork.Ordenes.GetAllAsync();
        ...
        {
            var entidad = await _unitOfWork.Ordenes.GetByIdAsync(id);
            if(entidad == null)
            {
                return NotFound();
            }
        ...
        public async Task<ActionResult<Orden>> Post(OrdenDto OrdenDto)
        {
            ...
            this._unitOfWork.Ordenes.Add(entidad);
        ...
        public async Task<ActionResult<OrdenDto>> Put(int id, [FromBody] OrdenDto OrdenDto)
        {
            ...
            _unitOfWork.Ordenes.Update(entidades);
            await _unitOfWork.SaveAsync();
            return OrdenDto;
        }
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            _unitOfWork.Ordenes.Delete(entidad);
            await _unitOfWork.SaveAsync();
            return NoContent();
        }
    }
